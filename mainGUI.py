...
class UserManagement:
    def __init__(self, master):
        ...
        master.geometry(f"{window_width}x{window_height}+{(screen_width-window_width) // 2}+{(screen_height - window_height) // 2}")
    ...
    def create_widgets(self, window_width):
        ...
        tk.Button(self.master, text='Signup', width=50, command='').pack(pady=5, padx=10)
